  ...
  <div class="right-bar">
    ...
    <div class="slimscroll-menu">
        ...
        <div class="p-4">
            ...
            <div class="custom-control custom-switch mb-3">
                <input type="checkbox" class="custom-control-input theme-choice" id="dark-mode-switch" data-bsStyle="{{ asset('backend') }}/css/bootstrap-dark.min.css" 
                    data-appStyle="{{ asset('backend') }}/css/app-dark.min.css" />
